...
[^fn89]: See {cite:t}`Calvo1988` and Evans, Honkapohja, and Sargent (1993) for setups in which a fraction $1 - \mu$ of agents is rational, and a fraction $\mu$ is 'adaptive' in particular senses. Both of these contributions are concerned with studying how dynamics might differ from the rational expectations dynamics even with a very small $\mu$.
