...
(sec-model-of-bray)=
## A model of Bray Margaret {cite:t}`Bray1982` studied a model that exhibits several features of systems that are adapting their way to a rational expectations equilibrium. These features include:
