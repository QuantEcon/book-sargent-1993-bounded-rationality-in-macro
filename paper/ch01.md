...
```{image} figures/_page_3_Picture_0.jpeg
:alt: Portrait of Arne Ryde
:width: 45%
:align: center
```

**ARNE RYDE**
*8 December 1944 – 1 April 1968*
...
[^fn2]: Because of limitations of space in this essay and knowledge in my head, I neglect two large and important related literatures: on learning in games, and on equilibria with Bayesian learning. David {cite:t}`Kreps1990` provides a good introduction to issues about learning in games. {cite:t}`MarimonMcGrattan1993` and {cite:t}`BlumeEasley1992` provide surveys of parts of the literature not treated here. Also see {cite:t}`BrayKreps1987`, {cite:t}`Feldman1987`, {cite:t}`Kiefer1989`, {cite:t}`Nyarko1993`, {cite:t}`NyarkoOlson1991`, and {cite:t}`ElGamalSundaram1993`.
